  ...
  modalContainer.innerHTML = `
      <dialog id="my_modal_1" class="modal">
        <div class="modal-box space-y-2">
            ...
            <h3 class="text-xl bg-lime-300 rounded-xl">Model: ${slug}</h3>
            <h3 class="text-xl">Chipset: ${chipSet}</h3>
            <h3 class="text-xl">Display-size: ${displaySize}</h3>
            <h3 class="text-xl">Memory: ${memory}</h3>
            <h3 class="text-xl">Storage: ${storage}</h3>
